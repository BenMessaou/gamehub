...
// views/article/show.php (VERSION MISE À JOUR POUR LE TÉLÉCHARGEMENT PDF)
...
// L'ID de l'article est supposé être dans $article['id'] ou $article['id_article']

$article_id = $article['id'] ?? $article['id_article'] ?? null;



if (!$article_id || empty($article)) {
...
<head>
    ...
    <style>
        ...
        .download-btn { background-color: #f7a01a; text-decoration: none; } /* Nouveau style pour le bouton Télécharger */
        ...
        .download-btn:hover { background-color: #c48015; }
        ...
        <div class="article-view">
            ...
            <article class="article-content">
                ...
                <div style="margin-top: 30px; margin-bottom: 20px;">
                    ...
                    <a href="../controllers/PDFController.php?action=downloadArticle&id=<?php echo $article_id; ?>"

                       class="action-btn download-btn" target="_blank" style="font-size: 1rem; padding: 10px 15px;">
            ...
            <div class="comment-section">
                ...
                <div class="comment-form-box">
                    ...
                    <form action="../controllers/CommentController.php?action=store" method="POST" novalidate>
                        ...
                        <?php foreach ($comments as $comment): ?>
                            ...
                            <div class="comment-item">
                                ...
                                <div class="comment-actions">
                                    ...
                                    // Utilise $comment['user_id'] (ou la clé appropriée) pour la vérification

                                    if (($comment['user_id'] ?? null) == $CURRENT_USER_ID):
