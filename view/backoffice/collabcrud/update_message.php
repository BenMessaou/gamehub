...
if (!$data || !isset($data['message_id']) || !isset($data['message'])) {
    http_response_code(400);
    echo json_encode(['success' => false, 'message' => 'Message ID and message content are required']);
    exit;
}
...
$success = $messageController->updateMessage($messageId, $newMessage);
